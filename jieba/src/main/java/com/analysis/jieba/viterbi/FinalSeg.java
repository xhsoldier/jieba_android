package com.analysis.jieba.viterbi;
...
import com.analysis.jieba.CharacterUtil;
import com.analysis.jieba.Pair;
import com.analysis.jieba.Node;


public class FinalSeg {
    private static FinalSeg singleInstance;
    private static final String PROB_EMIT = "/resources/prob_emit.txt";
